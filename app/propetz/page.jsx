    ...
    <>
      ...
      <div className="gap-5 lg:gap-[82px] mt-7 flex flex-col lg:flex-row mx-auto w-[90%] lg:w-[95%] xl:w-[78%]">
        ...
        <div className="flex-1">
          ...
          <p className="mt-8"></p>
          <Link className="font-medium mx-auto lg:mx-0 px-[18px] py-[13px] bg-purple-700 text-white transition-colors hover:bg-purple-500" href="/produtos/propetz">Produtos</Link>
        </div>
      </div>
    </>
  );
